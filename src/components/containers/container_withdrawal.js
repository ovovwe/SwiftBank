                            ...
                            <div className="card border-radius-6 shadow">
                                <div className="card-body">
                                    <form className="form" action="#" method="post">
                                        ...
                                        <div className="form-group row">
                                            <label for="actNo" className="col-sm-3 col-form-label">Account
                                                Number</label>
                                            <div className="col-sm-9">
                                        ...
                                        <div className="form-group">
                                            <p for="amount" className="text-success font-weight-bold">Fetched account
                                                name found!</p>
                                            <p for="amount" className="text-danger font-weight-bold">Fetched account
                                                name not found!</p>
                                        </div>

                                        <p for="amount" className="text-primary font-weight-bold">We need your pin to
