                                ...
                                <div className="card-body">
                                    <form className="form" action="#" method="post">
                                        ...
                                        <div className="form-group row">
                                            ...
                                            <div className="col-sm-9">
                                                <p for="amount" className="text-success font-weight-bold">Fetched
                                                    account name found!</p>
                                                <p for="amount" className="text-danger">We couldn't find an account with
                                                    that account number!</p>
                                            </div>
                                        </div>

                                        <div className="form-group row">
                                            <label for="pin" className="col-sm-3 col-form-label">Narration</label>
                                            <div className="col-sm-9">
