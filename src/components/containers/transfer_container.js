                                    ...
                                    <form className="form" action="#" method="post">
                                        ...
                                        <div className="form-group row">
                                            ...
                                            <div className="col-sm-9">
                                                ...
                                                <p for="amount" className="text-danger">We couldn't find an account with that account number!</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="form-group row">
                                            ...
                                            <div className="col-sm-9">
                                                <textarea className="form-control" placeholder="Narration (optional)"></textarea>
                                            </div>
                                        </div>
                                        <div className="form-group row">
                                            <label className="col-sm-3 "></label>
